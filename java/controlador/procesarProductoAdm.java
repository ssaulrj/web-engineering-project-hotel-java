 ...
 * @author Saulp
 */
public class procesarProductoAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                 ...
                 //ArrayList<Producto> miLista2 = BOProcesarFormulario2.generaListaDatos2(); 
                 //miSession.setAttribute("lista2", miLista2);
                 response.sendRedirect("/peluche2semi/jsp/mostradoradm.jsp"); //Vincular a jsp
        }
