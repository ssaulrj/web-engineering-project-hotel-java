 ...
 * @author Saulp
 */
public class ProcesarServicios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
           throws ServletException, IOException {
                 ...
                 ArrayList<Usuarios> miLista2 = BOProcesarUsuarios.generaListaUsuarios(textoidlugar); 
                 miSession.setAttribute("lista2", miLista2);
                 response.sendRedirect("/hotelSPA/jsp/mostradorUsuarios.jsp"); //Vincular a jsp
        }
