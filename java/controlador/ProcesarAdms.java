 ...
 * @author Saulp
 */
public class ProcesarAdms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
                String textoidlugar = request.getParameter("datalugar");
                 ...
                 ArrayList<Administradores> miLista3 = BOProcesarUsuarios.generaListaAdms(textoidlugar); 
                 miSession.setAttribute("lista3", miLista3);
                 response.sendRedirect("/hotelSPA/jsp/mostradorAdms.jsp"); //Vincular a jsp
        }
