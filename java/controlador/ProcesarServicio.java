 ...
 * @author SQL&MySQL
 */
public class ProcesarServicio extends HttpServlet{
    protected void processRequest (HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Servicio> miLista2 = BOProcesarUsuarios.generaListaServicio(textoidlugar); 
        miSession.setAttribute("lista2", miLista2);
        response.sendRedirect("/hotelSPA/jsp/mostradorServicio.jsp");
    }
