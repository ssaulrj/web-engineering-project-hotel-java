				...
				<!-- Main -->
					<article id="main">
					    <header>
                                                  ...
                                                  <a href="#one" class="more scrolly">¡Ver tabla!</a>
                                                  <div class="form-group">
                                                            <label for="habitacionC">Tipo habitación:</label>
                                                            <datalist id="listaHab">
                                                            <option value="Doble"></option>
                                                            <option value="Familiar"></option>
                                                            <option value="Pareja"></option>
                                                            ...
                                                            <input list="listaHab" type="text" name="tiphabicacion" class="form-control" id="tiphabicacion" placeholder="tiphabicacion"  title="tiphabicacion" onkeypress="return ValidarPalabra(event,this)"  maxlength="10" required />
                                                 </div>
                                                   <label >Tú ubicación es:</label>
                                                    ...
                                                    <input list="listaGPS" type="text" name="GPShabx" class="form-control" id="GPShabx" placeholder="GPShabx" title="GPShabx" value="" onkeypress="return ValidarPalGPShabxabra(event,this)"  maxlength="15"  required/>

                                                  <div class="clearfix">
                                                    <input  type="button" id="btntipohabitacion" value="Buscar tipo de habitacion" class="btn btn-success btn-lg" />
                                                  </div>
					    </header>
					    <section class="wrapper style5">
                                        ...
                                        <!--DATAAAAAAAAAAAAAAAAATABLE---------------------------------------------->                            
                                            ...
                                            <div id="one" class="container">
                                              <table id="miHabitacion" class="table table-striped dt-responsive nowrap" style="width:100%">
                                                 <thead>
                                                     <tr>
                                                         <th># Habitacion</th>
                                                         <th># Personas</th>
                                                 ...
                                                 <tbody>
                                                 <c:forEach var="miHabitacion" items="${lista2}">
                                                     <tr> 
                                                     <td> ${miHabitacion.numhab} </td>
                                                     <td> ${miHabitacion.numper} </td>
                                                     <td> ${miHabitacion.tipoh} </td>
                                                     <td> ${miHabitacion.precio} </td>
                                                     <td> ${miHabitacion.disponible} </td>
                                                    </tr>
                                                 </c:forEach>   
                                                 </tbody>
                                                 <tfoot>
                        ...
                        <div class="form-group">
                            <label for="last-name">Asignar habitación</label>
                            <label for="last-name">Id:</label>
                            <input type="text" class="form-control" placeholder="idhab" id="idhab"  title="idhab" value=""  maxlength="7" autocomplete="on" required>
                        </div>
                        <div class="form-group">
                            <label for="last-name"># Habitación:</label>
                            <input type="text" class="form-control" placeholder="numhab" id="numhab"  title="numhab" value=""  maxlength="4" autocomplete="on" required>
                        </div>
                        <label >Tú ubicación es:</label>
                                                    <datalist id="listaGPS">
                                                        <option value="CANCUN"></option>
                                                    ...
                                                    <input list="listaGPS" type="text" name="GPShabx2" class="form-control" id="GPShabx2" placeholder="GPShabx2" title="GPShabx2" value="" onkeypress="return ValidarPalGPShabxabra(event,this)"  maxlength="15"  required/>
                        ...
                        <div class="clearfix">
                                <input  type="button" id="asignarhab" value="Asignar" class="btn btn-success btn-lg" />
                        </div>
                        ...
                        <div class="form-group">
                            <label for="last-name">Desocupar habitación</label>
                            <label for="last-name"># Habitación:</label>
                            <input type="text" class="form-control" placeholder="numhabdes" id="numhabdes"  title="numhabdes" value=""  maxlength="40" autocomplete="on" required>
                        </div>
                        <label >Tú ubicación es:</label>
                                                    <datalist id="listaGPS">
                                                        <option value="CANCUN"></option>
                                                    ...
                                                    <input list="listaGPS" type="text" name="GPShabx3" class="form-control" id="GPShabx3" placeholder="GPShabx3" title="GPShabx3" value="" onkeypress="return ValidarPalGPShabxabra(event,this)"  maxlength="15"  required/>

                        <br/>
                        <br/>
                        <br/>
                        <div class="clearfix">
                                <input  type="button" id="desocuparhab" value="Desocupar" class="btn btn-success btn-lg" />
                        </div>
</body>
