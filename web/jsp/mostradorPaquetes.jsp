        ...
        <h2> Habitaciones SPA </h2>        
				...
				<!-- Main -->
					<article id="main">
					    ...
					    <section class="wrapper style5">
                                        ...
                                        <!--DATAAAAAAAAAAAAAAAAATABLE---------------------------------------------->                            
                                         ...
                                         <div id="one" class="container">
                                            <table id="miPaquete" class="table table-striped dt-responsive nowrap" style="width:100%">
                                                 <thead>
                                                     <tr>
                                                         <th>ID paquete</th>
                                                         <th>Producto 1</th>
                                                 ...
                                                 <tbody>
                                                 <c:forEach var="miPaquete" items="${lista2}">
                                                     <tr> 
                                                     <td> ${miPaquete.idpaquete} </td>
                                                     <td> ${miPaquete.prod1} </td>
                                                     <td> ${miPaquete.prod2} </td>
                                                     <td> ${miPaquete.prod3} </td>
                                                     <td> ${miPaquete.prod4} </td>
                                                     <td> ${miPaquete.prod5} </td>
                                                     <td> ${miPaquete.valor} </td>
                                                     <td> ${miPaquete.vigencia} </td>
                                                    </tr>
                                                 </c:forEach>   
                                                 </tbody>
                                                 <tfoot>
                        ...
                        <!--<div class="form-group">
                            <label for="last-name">Actualizar paquete:</label>
                            <label for="last-name">$:</label>
                            <input type="text" class="form-control" placeholder="Precio paquete" id="precioPaquete"  title="Precio paquete" value=""  maxlength="40" autocomplete="on" required>
                        </div>
                        <div class="form-group">
                            <label for="last-name">Tipo paquete:</label>
                            <input type="text" class="form-control" placeholder="Tipo paquete" id="tipoPaquete"  title="Tipo paquete" value=""  maxlength="40" autocomplete="on" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input list="listaGPS2" type="text" class="form-control" placeholder="Lugar" id="lugarPaquete"  title="Lugar" value=""  maxlength="40" autocomplete="on" required>
                        </div>
                        <br/>
                        <br/>
                        <br/>
                        <div class="clearfix">
                                <input  type="button" id="actualizarPaquete" value="Actualizar Paquete" class="btn btn-success btn-lg" />
                        </div>-->
